self.addEventListener('install', (e) => {
    e.waitUntil(
      caches.open('install-store').then((cache) => cache.addAll([
        ...
        'https://cdn.jsdelivr.net/npm/material-icons@latest/iconfont/material-icons.min.css',
        'https://cdn.jsdelivr.net/npm/material-icons@latest/iconfont/material-icons.woff2',
        'https://cdn.jsdelivr.net/npm/material-icons@latest/iconfont/material-icons-outlined.woff2',
